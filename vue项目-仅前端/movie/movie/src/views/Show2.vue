<template>
    <div class="main-show">
        ...
        <div class="movie-show-title">
            ...
            <h2 class="title">西虹市首富</h2>
            <div class="info">
                <p class="info2">
                    <span class="pingfen">8.8</span>
                </p>
            </div>
            <el-tag>4K</el-tag>
            <el-tag>喜剧</el-tag>
        ...
        <div class="movie-show-comment">
            ...
            <h2 style="color:#eee"> 精彩评论(435)</h2>
            <ul class="list-group">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                videoUrl:[{"name":"视频2","url":require('../static/video/mv2.mp4'),
                    "image":require('../static/images/film2.jpg')}],
                playerOptions : {
                    ...
                    sources: [{
                        ...
                        src: require('../static/video/mv2.mp4') //url地址
                    }],
                    poster: require('../static/images/film2.jpg'), //你的封面地址
                ...
                list: [
                    {id: Date.now(), user:'泡泡电影前线', content: '真心的感谢这部电影给我带来的体验与感受，感觉到要成大事必须有坚韧不拔的意志。'},
                    {id: Date.now(), user:'迷影映画', content:'作为搞笑片还不错，比起当年的《人在囧图》差了点，搞笑的地放有些太一般。'},
                    {id: Date.now(), user:'湫兮似椿 ', content:'金钱买得来婚姻却买不来爱情，买得来棉被买不来温暖。'}
                ],
            }
