<template>
    <div class="main-show">
        ...
        <div class="movie-show-comment">
            ...
            <h2 style="color:#eee"> 精彩评论(223)</h2>
            <ul class="list-group">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                videoUrl:[{"name":"视频1","url":require('../static/video/mv1.mp4'),
                    "image":require('../static/images/film1.jpg')}],
                playerOptions : {
                    ...
                    sources: [{
                        ...
                        src: require('../static/video/mv1.mp4') //url地址
                    }],
                    poster: require('../static/images/film1.jpg'), //你的封面地址
                ...
                list: [
                    {id: Date.now(), user:'每日MV君 ', content: '片中导演很巧妙的把种族文化融入其中，还有人物塑造的文化思想表达的很好。'},
                    {id: Date.now(), user:'Raah', content:'致敬叶问，为我是个中国人而感到骄傲。'},
                    {id: Date.now(), user:'LosonXu ', content:'丹哥演得真的太好了，感觉这个角色足以盖住他其他所演角色的光芒，让人感觉他就是叶问。'}
                ],
            }
