<template>
    <div class="main-show">
        ...
        <div class="movie-show-comment">
            ...
            <h2 style="color:#eee"> 精彩评论(221)</h2>
            <ul class="list-group">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                videoUrl:[{"name":"视频3","url":require('../static/video/mv3.mp4'),
                    "image":require('../static/images/film3.jpg')}],
                playerOptions : {
                    ...
                    sources: [{
                        ...
                        src: require('../static/video/mv3.mp4') //url地址
                    }],
                    poster: require('../static/images/film3.jpg'), //你的封面地址
                ...
                list: [
                    {id: Date.now(), user:'karry', content: '我觉得唐人街这部电影蛮好看的，不管在制作上面还是特效上面，演员上面都很让我震撼。'},
                    {id: Date.now(), user:'BunnySweet ', content:'只求在开学前能放啊！其实我希望能在手机上买这部电影，用平时电影票的价嘛。'},
                    {id: Date.now(), user:'赖崇梁', content:'作为探案剧不能光搞笑，多花心思构思剧本案件。'}
                ],
            }
