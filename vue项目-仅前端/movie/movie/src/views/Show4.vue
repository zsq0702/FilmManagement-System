<template>
    <div class="main-show">
        ...
        <div class="movie-show-comment">
            ...
            <h2 style="color:#eee"> 精彩评论(551)</h2>
            <ul class="list-group">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                videoUrl:[{"name":"视频4","url":require('../static/video/mv4.mp4'),
                    "image":require('../static/images/film4.jpeg')}],
                playerOptions : {
                    ...
                    poster: require('../static/images/film4.jpeg'), //你的封面地址
                ...
                list: [
                    {id: Date.now(), user:'Kulta', content: '人都死了，生活仍在继续，谁还会记得你呢？。'},
                    {id: Date.now(), user:'树暖情痴', content:'一个书中人物的坚强，而是所有心有善良，还依然愿意相信这个世界美好的年轻人的选择。'},
                    {id: Date.now(), user:'海绵宝宝', content:'本以为自己看这部电影是不会哭的，可是一直到最后还是哭的稀里哗啦。'}
                ],
            }
